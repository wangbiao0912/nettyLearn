package com.after00.netty.client;

import com.after00.netty.protobuf.UserMsg;
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object obj) throws Exception {
        ...
        if (obj instanceof IdleStateEvent) {
            ...
            if (IdleState.WRITER_IDLE.equals(event.state())) {
                UserMsg.User.Builder userState = UserMsg.User.newBuilder().setState(2).setName("wangbiao").setId(fcount.get());
